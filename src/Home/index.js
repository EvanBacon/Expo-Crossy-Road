...
const styles = StyleSheet.create({
  ...
  coins: {
    position: 'absolute', top: Constants.statusBarHeight, right: 8, color: '#f8e84d', fontSize: 36,letterSpacing: 0.9, backgroundColor: 'transparent',  textAlign: 'right', shadowColor: 'black', shadowOpacity: 1, shadowRadius: 0, shadowOffset: {width: 0, height: 0}
  },
  paragraph: {
    margin: 24,
    fontSize: 18,
